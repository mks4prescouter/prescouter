var exceptionHandlerService=angular.module('services.exceptionHandler', ['services.i18nNotifications']);

exceptionHandlerService.factory('exceptionHandlerFactory', ['$injector', function($injector) {
...
exceptionHandlerService.config(['$provide', function($provide) {
